<div class="modal fade" id="buy-monthly-subscription-code-modal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Buy subscription code (1 month)</h4>
            </div>
...
@push('scripts-footer')
    <script>
        $(document).on('shown.bs.modal', '#buy-monthly-subscription-code-modal', function (e) {
            var modal = $(this);
            ...
            $.ajax({
                ...
                type: 'POST',
                data: {
                    plan_id: 'followouts-pro-monthly',
                },
